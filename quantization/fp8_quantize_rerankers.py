#!/usr/bin/env python3
"""
FP8 Quantization Script - Reranker Models

llmcompressor를 사용하여 리랭커 모델 전체를 FP8로 양자화하고 Hugging Face에 업로드합니다.
...
Usage:
    python fp8_quantize_rerankers.py
...
# 양자화할 리랭커 모델 목록 (VL → Reranker → bge 순서)
MODELS = [
...
def quantize_and_upload(model_id: str, output_dir: str, repo_id: str, hf_token: str):
    ...
    if mtype == "vl":
        ...
        # Use AutoModelForSequenceClassification to preserve classifier head
