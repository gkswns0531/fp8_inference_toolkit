...
| Model | 128 tok | 256 tok | 512 tok | 1024 tok | 2048 tok | 4096 tok | 8192 tok |
|-------|---------|---------|---------|----------|----------|----------|----------|
| Qwen3-Embedding-0.6B | 3.6 ms | 3.8 ms | 4.5 ms | 7.6 ms | 11.7 ms | 21.9 ms | 69.9 ms |
| Qwen3-Embedding-4B | 9.9 ms | 10.0 ms | 15.2 ms | 22.4 ms | 37.9 ms | 68.4 ms | 267.9 ms |
| Qwen3-Embedding-8B | 15.8 ms | 16.1 ms | 24.1 ms | 37.2 ms | 58.1 ms | 114.3 ms | 416.1 ms |
| Qwen3-VL-Embedding-2B | 5.0 ms | 5.2 ms | 7.4 ms | 10.7 ms | 19.3 ms | 36.6 ms | 118.6 ms |
| Qwen3-VL-Embedding-8B | 16.1 ms | 16.5 ms | 24.3 ms | 37.2 ms | 57.6 ms | 113.3 ms | 415.3 ms |
| bge-m3 | 2.5 ms | 2.8 ms | 4.5 ms | 6.0 ms | 9.9 ms | 18.8 ms | N/A |

## Key Results (Batch=16, P50 Latency)

| Model | 128 tok | 256 tok | 512 tok | 1024 tok | 2048 tok | 4096 tok | 8192 tok |
|-------|---------|---------|---------|----------|----------|----------|----------|
| Qwen3-Embedding-0.6B | 15.8 ms | 20.1 ms | 33.9 ms | 64.6 ms | 126.3 ms | 278.2 ms | 1,059 ms |
| Qwen3-Embedding-4B | 62.1 ms | 66.8 ms | 116.9 ms | 233.1 ms | 475.5 ms | 1,814 ms | 4,210 ms |
| Qwen3-Embedding-8B | 105.3 ms | 109.7 ms | 194.8 ms | 369.7 ms | 757.4 ms | 2,981 ms | 6,526 ms |
| Qwen3-VL-Embedding-2B | 30.9 ms | 30.6 ms | 52.3 ms | 99.3 ms | 190.2 ms | 403.7 ms | 1,670 ms |
| Qwen3-VL-Embedding-8B | 115.6 ms | 121.8 ms | 199.9 ms | 361.5 ms | 725.6 ms | 2,900 ms | 6,362 ms |
| bge-m3 | 11.3 ms | 16.4 ms | 31.1 ms | 57.8 ms | 122.9 ms | 276.3 ms | N/A |
...
- **vLLM loading**: `LLM(runner="pooling", convert="embed", enforce_eager=False)`
- **max_model_len**: 8200 (headroom for BOS token; vLLM adds 1 token internally)
- **GPU memory utilization**: 90%
- **CUDA graphs**: enabled (`enforce_eager=False`)
- **Warmup runs**: 3 (per configuration, discarded)
- **Timed runs**: 10 (per configuration)
- **Batch sizes**: 1, 4, 8, 16
- **Input lengths**: 128, 256, 512, 1024, 2048, 4096, 8192 tokens
- **Prefix caching**: defeated (different text per batch item, staggered offset slicing)
- **Token count**: exact (tokenizer encode → slice → decode → re-encode verification)
- **Source text**: War and Peace (Project Gutenberg), ~340K tokens available
- **bge-m3 8192 tok**: N/A — model's max_context=8192, with BOS token overhead exceeds limit
